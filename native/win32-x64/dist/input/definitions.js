...
exports.UNIFIED_KEY_ID = exports.MODIFIER_KEYS = exports.VKEY_MAP = void 0;
exports.isModifierKey = isModifierKey;
exports.isCommonModifierKey = isCommonModifierKey;
...
exports.MODIFIER_KEYS = new Set([
    17, 16, 18, 160, 162, 164, 91, 161, 163, 165, 92
]);
exports.UNIFIED_KEY_ID = {
    16: 'Shift',
    160: 'Shift',
    161: 'Shift',
    162: 'Control',
...
const COMMON_MODIFIER_KEYS = new Set([
    // Alt
    18,
    // SHIFT
    16,
...
function isModifierKey(keyCode) {
    return exports.MODIFIER_KEYS.has(keyCode);
}
function isCommonModifierKey(keyCode) {
