...
// from global-key-listener
export const VKEY_MAP: KeyDefinitionMap = {
  1: {
    _nameRaw: 'VK_LBUTTON',
    name: 'LBUTTON',
  ...
  4: {
    _nameRaw: 'VK_MBUTTON',
    name: 'MBUTTON',
    standardName: 'MOUSE MIDDLE',
    keyId: 'MiddleMouseButton'
  },
  5: {
...
export const MODIFIER_KEYS = new Set<VirtualKeyCode>([
  17, 16, 18, 160, 162, 164, 91, 161, 163, 165, 92
])

export const UNIFIED_KEY_ID: UnifiedKeyIdMap = {
  16: 'Shift',
  160: 'Shift',
  161: 'Shift',
  162: 'Control',
...
const COMMON_MODIFIER_KEYS = new Set<VirtualKeyCode>([
  // Alt
  18,
...
export function isModifierKey(keyCode: VirtualKeyCode) {
  return MODIFIER_KEYS.has(keyCode)
}

export function isCommonModifierKey(keyCode: VirtualKeyCode) {
  return COMMON_MODIFIER_KEYS.has(keyCode)
}
