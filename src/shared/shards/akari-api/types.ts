// LeagueSol has no remote config/release service of its own yet. These must never point at the
// upstream League Akari service: doing so would pull upstream's feature gates and notices, and
// would offer to "update" LeagueSol into League Akari. Until a LeagueSol service exists these
// hosts do not resolve, which leaves remote config, notices and self-update inert by design.
export const DEFAULT_AKARI_API_BASE_URL = 'https://api.leaguesol.invalid'
export const DEFAULT_AKARI_STATIC_BASE_URL = 'https://static.leaguesol.invalid'
